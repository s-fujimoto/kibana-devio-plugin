define(function (require) {
    ...
    var module = require('ui/modules').get('kibana/devio_values_vis', ['kibana']);
    var d3 = require('d3');
    var _ = require('lodash');
    var $ = require('jquery');
    var numeral = require('numeral');

    module.controller('devioController', function ($scope, $element, $rootScope, Private) {
        $scope.$watch('esResponse', function (resp) {
            var value = resp["aggregations"]["1"]["value"] * 100;
            
            if (d3.selectAll("g")[0].length !== 0) {
                $scope.gaugeUpdater.update(value);
                return;
            }
            
            d3.selectAll("g").remove();
            var elementId = "elament1";
            ...
            $scope.gaugeUpdater = new GaugeUpdater();
        });
    });
});
/*!
